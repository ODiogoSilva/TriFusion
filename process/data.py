...
class Partitions ():
    """ The Partitions class is used to parse and work with partition files.
    Currently the supported input formats are RAxML partition files and Nexus
     chartset blocks. To initialize a class, only a file partition file is
      required. """
    ...
    def _get_partitions(self, partitions_file):
        ...
        if self.partition_format == "raxml":
            for line in part_file:
                ...
                # Format of partition storage: [# "str","str",["str","str"]]
                partition_storage.append((model,
                                          partition_name,
                                          partition_range))
            ...
            for line in part_file:
                ...
                # Format of partition storage: ["str", str", ["str","str"]]
                partition_storage.append((self.model_nexus,
                                          partition_name,
                                          partition_range))
