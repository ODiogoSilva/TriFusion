...
informative_storage = {
    ...
    "info_nucleotide_proportion":
        ["[b]Nucleotide or residue proportion - Help[/b]",
         "[color=37abc8ff][b]Available options:[/color] Per species; Average["
         "/b]\n\n"
         "[color=37abc8ff][b]Per species[/color][/b]: Creates a stacked bar "
         ...
         "[b]x-axis:[/b] Taxon name\n\n"
         "[color=37abc8ff][b]Average[/color][/b]: Creates a  bar plot "
    ...
    "info_taxa_frequency":
        ["[b]Distribution of taxa frequency - Help[/b]",
         ...
         "[color=37abc8ff][b]Average[/color][/b]: Creates an histogram with "
    ...
    "pairwise_seq_similarity":
        ["[b]Pairwise sequence similarity - Help[/b]",
         ...
         "[color=37abc8ff][b]Single gene[/color][/b]: Creates a sliding "
    ...
    "gene_occupancy":
        ["[b]Gene occupancy - Help[/b]",
         "[color=37abc8ff][b]Available options:[/color] Average[/b]\n\n"
         "[color=37abc8ff][b]Average[/color][/b]: Creates an interpolation "
    ...
    "outliers_missing":
        ["[b]Missing data outliers - Help[/b]",
         ...
         "size.[/b]\n\n"
         "[color=37abc8ff][b]Per species[/color][/b]: Creates a smooth line "
