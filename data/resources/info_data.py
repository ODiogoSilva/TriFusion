...
informative_storage = {
    "process_dataset": ["[b]Data set selection - Help[/b]", "The '[b]"
        ...
        "operations on specific sets of taxa. User specified groups of taxa can"
        " be selected by toggling the taxon buttons in 'Menu > Open/View data' "
        "and selecting the 'Active taxa' option or by creating taxa groups in "
        "'Menu > Taxa Groups' and selecting the name of the corresponding taxa "
        "group."],
    "zorro": ["[b]ZORRO weights - Help[/b]", "(Concatenation only)\n\nThis "
        ...
        "ZORRO software (Wu M et al. 2012, PLoS ONE 7(1): e30288).\n\nIn order "
        "to maintain correspondence between the alignment and weight files, the"
