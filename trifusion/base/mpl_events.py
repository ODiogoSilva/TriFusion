...
class ShowTooltip(object):
    ...
    def __init__(self, plot_obj, canvas, plt_idx):
        ax = plot_obj.gca()
    ...
    def connect(self):
        self.tooltip = self.canvas.mpl_connect("motion_notify_event", self.show_tooltip)
    ...
    def __call__(self, event):
        ...
        # Ignore when the even is outside axes
        if not event.inaxes:
            return
